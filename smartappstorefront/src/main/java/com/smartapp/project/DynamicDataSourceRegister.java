...
public class DynamicDataSourceRegister implements ImportBeanDefinitionRegistrar, EnvironmentAware, ApplicationContextAware {
    ...
    public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry) {
        ...
        logger.info("Dynamic DataSource Registry Finished!");
    }
...
//        dsMap.put("password", propertyResolver.getProperty("password"));
        ...
        //defaultDataSource = applicationContext.getBean("secondaryDataSource", DataSource.class);
        defaultDataSource = secondaryDataSource();
